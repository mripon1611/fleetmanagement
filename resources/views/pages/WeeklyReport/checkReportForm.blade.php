                                    ...
                                    <div class="auth-box card-block">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 d-inline-block">
                                                ...
                                                <select id="select-vregno" class="form-control js-example-data-array select2-hidden-accessible" name="vregno">
                                            ...
                                            <div class="form-group col-md-12 d-inline-block" id="check-report-date">
